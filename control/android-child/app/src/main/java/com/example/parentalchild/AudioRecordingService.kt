...
/** Explicit, user-started audio recording. The foreground notification remains visible. */
class AudioRecordingService : Service() {
    ...
    private fun startRecording() {
        ...
        try {
            ...
            recordingFile = file
            updateNotification("🔴 Audio yozilmoqda")
        } catch (_: Exception) {
            releaseRecorder()
    ...
    private fun startRecordingForeground() {
        val notification = buildNotification("🔴 Audio yozilmoqda")
    ...
    private fun trimRecordings(dir: File) {
