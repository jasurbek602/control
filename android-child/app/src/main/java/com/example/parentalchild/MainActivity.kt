...
class MainActivity : AppCompatActivity() {
    ...
    private val telephonyLauncher = registerForActivityResult(
        ...
        setStatus(
            if (callOk && smsOk) "✅ Qo'ng'iroqlar va SMS ruxsatlari berildi"
            else "❌ Qo'ng'iroq yoki SMS ruxsati rad etildi"
        )
    }
    ...
    private fun showHideAppDialog() {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Ha, yashirilsin") { dialog, _ ->
                hideLauncherIcon(); dialog.dismiss()
            }
    ...
    private fun requestTelephonyPermissions() {
        telephonyLauncher.launch(arrayOf(
    ...
    private fun requestAccessibility() {
        ...
        setStatus("⚠️ Sozlamalar ochilmoqda")
